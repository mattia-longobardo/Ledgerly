...
import { KEY_ID, type KeyRing, parseKeyRing } from "./keyring";

// Re-exported so a caller that seals also gets the ring it seals with from one import.
export { type KeyRing, parseKeyRing };

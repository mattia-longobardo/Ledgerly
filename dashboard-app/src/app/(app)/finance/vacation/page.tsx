        ...
        <>
          <div className="px-4 pb-5">
            ...
            <p className="num mt-2 text-body-sm text-fg-muted">
              {rate === null ? "No accrual rule set" : `+${formatEur(rate)}/month`}
            </p>
          </div>
          ...
          <section className="mt-6">
            ...
            {entries.length === 0 ? (
              <p className="px-4 text-body-sm text-fg-muted">Nothing recorded yet.</p>
            ) : (
                ...
                {entries.map((entry) => (
                  ...
                  >
                    ...
                    <MoneyValue
                      ...
                      size="body"
                      className={
                        entry.amount.startsWith("-") ? "text-negative" : "text-positive"
                      }
                    />
                  </li>
                ))}
